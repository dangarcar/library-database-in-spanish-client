 ...
 * de Database Writable pasado por par�metro en el constructor
 * @author danie
 *
 */
public class GUIObjetosBiblioteca {
	...
	public JButton createGUIContenido() throws ExcepcionPerfil {
		...
		} else throw new ExcepcionPerfil("Est� m�todo no es aplicable para la clase Perfil",(Perfil) c);
	...
	public JButton createGUIPerfil() throws ExcepcionContenido {
		...
		} else throw new ExcepcionContenido("Est� m�todo no es aplicable para la clase Perfil",(Contenido) c);
