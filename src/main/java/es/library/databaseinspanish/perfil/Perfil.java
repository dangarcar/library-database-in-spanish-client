...
/**
 * Clase encargada de ser padre del resto de es.library.databaseinspanish.perfil, además de poder ser instancia para crear el objeto del perfil base, que serían los teóricos usuarios normales de la biblioteca
...
public class Perfil implements DatabaseWritable{
	...
	/**
	 * Este método añade el identificador del es.library.databaseinspanish.contenido pasado por parámetro<br>
	...
	/**
	 * Este método elimina el identificador del es.library.databaseinspanish.contenido pasado por parámetro<br>
	 * a la lista de contenidos en préstamo del perfil
	 * @param c El es.library.databaseinspanish.contenido a ser prestado
	 */
