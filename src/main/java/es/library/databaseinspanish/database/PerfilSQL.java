 ...
 * Los métodos devolver y prestar de esta clase solo modifican el perfil, no cogen ningún es.library.databaseinspanish.contenido en préstamo
...
public class PerfilSQL {
	 ...
	 * esta función no es válida para los es.library.databaseinspanish.perfil de usuario normales
	...
	/**
	 * Modifica el perfil añadiendo  el es.library.databaseinspanish.contenido c pasado por parámetro a la lista de contenidos en préstamo<br>
	...
	/**
	 * Modifica el perfil y elimina de la lista de prestados el es.library.databaseinspanish.contenido c pasado por parámetro<br>
